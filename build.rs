...
fn base_info() -> String {
	...
	base_info.push_str("use crate::base_info::BaseInfoPow2;\n");
	base_info.push_str("use crate::base_info::BaseInfoOther;\n");
	base_info.push_str("\n");
	base_info
	...
	for base in MIN_BASE..=MAX_BASE as usize {
		if base.is_power_of_two() {
			...
			base_info.push_str(&format!("\t\tbits_per_digit_ceil: {},\n", bits_per_digit));
			base_info.push_str(&format!("\t\tbits_per_digit_floor: {},\n", bits_per_digit));
			...
			base_info.push_str("\tBaseInfo::Other(BaseInfoOther {\n");
			base_info.push_str(&format!("\t\tbase: {},\n", base));
			base_info.push_str(&format!("\t\tbits_per_digit_ceil: {},\n", bits_per_digit_ceil));
